...
## Chapter 2
# Work Flow for creating a portfolio
...
port_spec <- add.constraint(portfolio = port_spec, type = "box", min = c(rep(0.1, times = 5), rep(0.05, times = 8)), max = 0.4)
...
r_benchmark <- Return.portfolio(R = edhec, weights = equal_weights, rebalance_on = "quarters")
